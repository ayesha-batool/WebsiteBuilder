...
const getCredits = async () => {
  try {
    ...
    toast.error("Failed to get credits", {
      ...
      <nav className="z-50 flex items-center justify-between w-full py-4 px-4 md:px-16 lg:px-24 xl:px-32 backdrop-blur border-b text-white border-slate-800">
        ...
        <div className="flex items-center gap-2">
         ...
         className="px-6 py-1.5 max-sm:text-sm bg-indigo-600 active:scale-95 hover:bg-indigo-700 transition rounded">
            ...
            className="bg-white/10 px-5 py-1.5 text-xs sm:text-sm border text-gray-200 rounded-full">
            ...
            <UserButton
              ...
              classNames={{
                content: {
                  base: "!max-h-[min(18rem,70vh)] overflow-y-auto overflow-x-hidden bg-slate-900/95 border-slate-700 text-white shadow-xl",
                  menuItem: "text-white focus:bg-slate-700 focus:text-white",
