  ...
  return (
    ...
    <div className="w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]">
      <div className="text-center mt-16">
        ...
        <p className="text-gray-400 mt-2">Choose the plan that's right for you and start creating your projects</p>
      </div>
      ...
      <p className="text-center mx-auto text-sm max-w-md mt-10 text-white/60 font-light">
      Project <span className="text-white">Creation / Revision </span> 
      consume <span className="text-white">5 
        credits</span>. You can add more credits to create more projects.</p>
    </div>
    <Footer />
    </>
  );
